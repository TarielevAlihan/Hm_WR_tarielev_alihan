...
def insert_students(conn):
    cursor = conn.cursor()
    cursor.execute("INSERT INTO students (first_name, last_name, city_id) VALUES (?, ?, ?)", ('Regina', 'Martin', 4))
    ...
    cursor.execute("INSERT INTO students (first_name, last_name, city_id) VALUES (?, ?, ?)", ('Wesley', 'Glover', 5))
    cursor.execute("INSERT INTO students (first_name, last_name, city_id) VALUES (?, ?, ?)", ('Charles', 'West', 1))
    cursor.execute("INSERT INTO students (first_name, last_name, city_id) VALUES (?, ?, ?)", ('Lois', 'Carter', 7))
    cursor.execute("INSERT INTO students (first_name, last_name, city_id) VALUES (?, ?, ?)", ('Margaret', 'Perez', 2))
    cursor.execute("INSERT INTO students (first_name, last_name, city_id) VALUES (?, ?, ?)", ('Grace', 'Lane', 6))
    ...
    cursor.execute("INSERT INTO students (first_name, last_name, city_id) VALUES (?, ?, ?)", ('Amogus', 'Impostor', 4))
    cursor.execute("INSERT INTO students (first_name, last_name, city_id) VALUES (?, ?, ?)", ('Piter', 'Parker', 1))
